...
- [x] QA local: `319/319` pruebas, reglas `13/13` en emulador aislado, TypeScript, lint sin errores, build con 30 rutas y navegador desktop/mobile sin overflow.
...
- [x] Publicar `main` en `origin/main` y verificar deployment Vercel en estado `Ready`.
